...
const CONSOLE: ThemeDefinition = {
  ...
  atmosphere: {
    ...
    primaryField: { color: "#E61919", positionX: 85, positionY: 85, radius: 70, opacity: 0.35 },
    secondaryField: { color: "#4AF626", positionX: 15, positionY: 15, radius: 50, opacity: 0.12 },
    tertiaryField: null,
    bloomColor: "#FF2A2A",
    bloomIntensity: 0.12,
...
const CANVAS: ThemeDefinition = {
  ...
  atmosphere: {
    ...
    primaryField: { color: "#C75B39", positionX: 20, positionY: 15, radius: 60, opacity: 0.2 },
    secondaryField: { color: "#F2D98B", positionX: 80, positionY: 80, radius: 55, opacity: 0.15 },
    tertiaryField: null,
    bloomColor: "#F2D98B",
    bloomIntensity: 0.1,
...
const AFTERNOON_DRIVE: ThemeDefinition = {
  ...
  atmosphere: {
    ...
    primaryField: { color: "#D4845A", positionX: 80, positionY: 15, radius: 60, opacity: 0.2 },
    secondaryField: { color: "#6B9B8A", positionX: 20, positionY: 85, radius: 55, opacity: 0.15 },
    tertiaryField: null,
    bloomColor: "#D4845A",
    bloomIntensity: 0.1,
...
const MIDNIGHT_RADIO: ThemeDefinition = {
  ...
  atmosphere: {
    ...
    primaryField: { color: "#3A3A8A", positionX: 20, positionY: 50, radius: 65, opacity: 0.3 },
    secondaryField: { color: "#C89B3C", positionX: 85, positionY: 80, radius: 55, opacity: 0.18 },
    tertiaryField: null,
    bloomColor: "#F0C040",
    bloomIntensity: 0.12,
    vignetteColor: "#000000",
...
const BLOSSOM: ThemeDefinition = {
  ...
  atmosphere: {
    ...
    primaryField: { color: "#E83A6F", positionX: 50, positionY: 25, radius: 60, opacity: 0.28 },
    secondaryField: { color: "#F0D0DC", positionX: 50, positionY: 55, radius: 50, opacity: 0.14 },
    tertiaryField: null,
    bloomColor: "#FF4D7A",
    bloomIntensity: 0.12,
    vignetteColor: "#000000",
